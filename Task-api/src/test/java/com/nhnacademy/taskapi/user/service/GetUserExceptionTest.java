...
public class GetUserExceptionTest {
    ...
    void getUserIdIsNullWhenThrowsIllegalArgumentException() {

        // given & when
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> userService.getUser(null));
    ...
    void getUserIdIsEmptyWhenThrowsIllegalArgumentException() {
        // given & when
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> userService.getUser(""));
    ...
    void getUserNotExistsWhenThrowsUserNotFoundException() {
        // given
